# HERMES 0.1.0-alpha12.0 local release checklist
...
4. Confirm the build project creates `HERMES-0.1.0-alpha12.0.zip` and deploys both DLLs when auto-deploy is enabled.
5. Start SPT.Server and confirm HERMES loads without DI or route errors.
6. Start the client and confirm the log reports `HERMES 0.1.0-alpha12.0 loaded`.
