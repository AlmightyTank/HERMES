...
public sealed record HermesCraftSummary(
    ...
    long EstimatedTraderSaleValue,
    long EstimatedTraderProfit,
    long EstimatedTraderProfitPerHour,
    bool FleaUnlocked,
    bool CanSellOnFlea,
    long EstimatedFleaNetSaleValue,
    long EstimatedFleaProfit,
    long EstimatedFleaProfitPerHour,
    string BestSaleSource,
    long EstimatedBestSaleValue,
    long EstimatedBestSaleProfit,
    long EstimatedBestSaleProfitPerHour,
    bool IsActive,
    bool IsComplete);
